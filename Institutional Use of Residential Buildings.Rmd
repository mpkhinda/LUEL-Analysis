...
ggplot()+
  ...
  geom_sf(data = institutional_buildings) +
  theme_map()
...
ggplot()+
  ...
  geom_sf(data = institutional_lots, aes(fill = PropertyClass), color = NA)+
  geom_sf(data=institutional_buildings, color = NA, fill = "black")+
  theme_map()
```
